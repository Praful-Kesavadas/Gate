...
\begin{figure}[ht!]
    \resizebox{0.9\textwidth}{!}{\input{figs/Rs1.tex}}
    %\caption{Block Diagram of System}
    %\label{fig:gate_ec_Q42_gatetex}
\end{figure}\\
\begin{figure}[ht!]
    \resizebox{0.9\textwidth}{!}{\input{figs/Rs2.tex}}
    %\caption{Block Diagram of System}
    %\label{fig:gate_ec_Q42_gatetex}
\end{figure}\\
\begin{align}
...
\begin{figure}[ht!]
    \resizebox{0.9\textwidth}{!}{\input{figs/Ds1.tex}}
    %\caption{When only R(s) is present}
    %\label{fig:gate_ec_Q42_Ds1tex}
\end{figure}
\begin{figure}[ht!]
\centering
\input{figs/Ds2.tex}
